import { Creator, MetadataArgs, TokenProgramVersion, TokenStandard, createMintToCollectionV1Instruction, PROGRAM_ID as BUBBLEGUM_PROGRAM_ID, createCreateTreeInstruction, } from "@metaplex-foundation/mpl-bubblegum";
    ...
    maxBufferSize: number = 64 ) 
{
    ...
    const collectionTokenAccount = await createAssociatedTokenAccount(connectionWrapper, payerKeypair, collectionMint, payer, null, null, null);//collectionMint.createAccount(payer)
    await mintTo(connectionWrapper, payerKeypair, collectionMint, payer, payer, 1);    
